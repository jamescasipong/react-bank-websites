...
const CTA = () => (
  ...
  <section className={`my-6 flex sm:flex-row flex-col justify-center items-center relative w-full pt-[40px] sm:pl-[60px] pl-[24px] sm:pb-[40px] pb-[20px] sm:pr-[60px] pr-[24px] bg-black-gradient-2 rounded-xl`}>
